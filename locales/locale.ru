...
Add nickname to message stanzas from strangers=Добавлять никнеймы в строф-сообщениях от неизвестных
Add nickname to presence stanzas=Добавлять никнеймы в строфу присутствия
Parse wall attachments=Анализировать вложения со стен
...
Send unavailable from friends when a user logs off=Отправка недоступна от друзей, когда пользователь выходит с сайта
